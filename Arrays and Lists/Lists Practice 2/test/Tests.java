...
public class Tests {
    public static ArrayList<Integer> exampleSolution(ArrayList<Integer> inputList) {
        // Implement the correct solution here
        inputList.add(inputList.remove(0));
        return inputList;
    }

    Object[][] valuesToCheck = {
            new Object[]{new ArrayList<>(Arrays.asList(1, 2, 3))},
            new Object[]{new ArrayList<>(Arrays.asList(-1, 10))},
            new Object[]{new ArrayList<>(Arrays.asList(5, 6, 7, 8, 8))},
            new Object[]{new ArrayList<>(Arrays.asList(-5, 0, 5, 0))},
            new Object[]{new ArrayList<>(Arrays.asList(2, 10, 3))},
    };
